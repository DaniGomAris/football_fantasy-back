...
def add_user():
    ...
    document, document_type, name, last_name1, last_name2, email, phone, password, re_password = extract_fields(
        data, "document", "document_type", "name", "last_name1", "last_name2", "email", "phone", "password", "re_password"
    )
